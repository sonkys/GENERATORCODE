...
*/
    ...
    if (isset($_REQUEST['data'])) { 
        ...
        QRcode::png('mailto:'.$_REQUEST['data'].'?subject=Demande de renseignements&body=Veuillez me re-contacter au plus vite sur mon email, Merci', $filename, $errorCorrectionLevel, $matrixPointSize, 2);    
    } else { 
    ...
    echo '<form action="mail.php" method="post">
        <b>Données :&nbsp;</b></br><input type="text" name="data" size="50" >Entrez votre adresse email de contact ici pour générer votre QRCode</br></br>
