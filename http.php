...
*/
    ...
    echo '<form action="http.php" method="post">
        <b>Données :&nbsp;</b></br><input type="text" name="data" size="50" >Entrez votre adresse HTTP ici pour générer votre QRCode</br></br>
