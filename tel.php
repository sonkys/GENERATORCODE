...
*/
    ...
    if (isset($_REQUEST['data'])) { 
        ...
        QRcode::png('tel:'.$_REQUEST['data'], $filename, $errorCorrectionLevel, $matrixPointSize, 2);    
    } else { 
    ...
    echo '<form action="tel.php" method="post">
        <b>Données :&nbsp;</b></br><input type="text" name="data" size="50" >&nbsp;Entrez votre numéro de téléphone (ex : +33699999999 ou 0699999999) ici pour générer votre QRCode</br></br>
