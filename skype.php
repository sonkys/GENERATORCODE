...
*/
    ...
    if (isset($_REQUEST['data'])) { 
        ...
        QRcode::png('skype:'.$_REQUEST['data'].'?call', $filename, $errorCorrectionLevel, $matrixPointSize, 2);    
    } else { 
    ...
    echo '<form action="skype.php" method="post">
        <b>Données :&nbsp;</b></br><input type="text" name="data" size="50" >&nbsp;Entrez le nom d\'utilisteur Skype ici pour générer votre QRCode</br></br>
